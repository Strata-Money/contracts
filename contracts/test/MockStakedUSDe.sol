...
import "./ethena/StakedUSDe.sol";
import "./ethena/interfaces/IStakedUSDeCooldown.sol";
import "./ethena/USDeSilo.sol";

/**
 * @title MockStakedUSDe
 * @notice The MockStakedUSDe contract allows users to stake USDe tokens and earn a portion of protocol LST and perpetual yield that is allocated
...
contract MockStakedUSDe is IStakedUSDeCooldown, StakedUSDe {
  ...
  /// @notice Constructor for MockStakedUSDe contract.
